...
client.on('ready', () => {
	...
	console.log(`Bot is online! Made by ZeRealOne#3663`)

client.user.setActivity(`Made by ZeRealOne#3663 | https://github.com/zerealone/discord-gen-bot`, { type: "WATCHING" });
})
